...
class BinnedPartitionUCB:
    """Fixed binned partition UCB agent for candidate-set bandits.
    ...
    def __init__(
        ...
        Args:
            ...
            depth: predefined depth of the partition tree.
            seed: Random seed.
        """
        self.d = d
        self.T = T
        ...
        # split the partition tree to the predefined depth  
